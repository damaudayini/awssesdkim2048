...
public class AmazonSESDKIMSIGN {
	...
	private static String SENDER = "udayini@gmail.com";

	private static String RECIPIENT = "udayini@gmail.com";

	private static String DOMAIN = "udayini.ae";

	private static String KEY_SELECTOR = "dkim2048";

	private static String PRIVATE_KEY_PATH = "/Users/user/projects/dkim2048/uat/private.key.der";

	private static String ACCESS_KEY_ID = "accesskey";
	private static String SECRET_KEY = "secretkey";
	
	private static String SES_TEMPLATE_NAME = "welcome";
